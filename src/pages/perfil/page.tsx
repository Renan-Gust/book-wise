...
import { User, BookOpen, BookCopy, Users2, Bookmark } from 'lucide-react';
    ...
    return(
        <>
            <div className='flex flex-wrap items-center justify-between gap-10'>
                ...
                <InputFilter placeholder='Buscar livro avaliado' />
            </div>

            <section className="mt-8 flex flex-wrap gap-16">
